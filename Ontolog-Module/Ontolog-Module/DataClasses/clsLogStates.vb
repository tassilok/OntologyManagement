Public Class clsLogStates
    ...
    Public Sub New()
        objLogState_Delete = New clsOntologyItem("BB6A95553AF640FC9FB0489D2678DFF2", "Delete", objClasses.OItem_Class_Logstate.GUID)
        objLogState_Error = New clsOntologyItem("cc71434176314b78b8f4385db073635f", "Error", objClasses.OItem_Class_Logstate.GUID)
        objLogState_Exists = New clsOntologyItem("0b285306f64d4444bffe627a21687eff", "Exist", objClasses.OItem_Class_Logstate.GUID)
        objLogState_Insert = New clsOntologyItem("a6df6ab2359045b1b32535334a2f574a", "Insert", objClasses.OItem_Class_Logstate.GUID)
        objLogState_Nothing = New clsOntologyItem("95666887fb2a416e-9624a48d48dc5446", "Nothing", objClasses.OItem_Class_Logstate.GUID)
        objLogState_Relation = New clsOntologyItem("a46b74723c8e44a8b7853913b760db", "Relation", objClasses.OItem_Class_Logstate.GUID)
        objLogState_Success = New clsOntologyItem("84251164265e4e0294b2ed7c40a02e56", "Success", objClasses.OItem_Class_Logstate.GUID)
        objLogState_Update = New clsOntologyItem("2bf7e9d6fb9c40929b16ecc4fef7c072", "Update", objClasses.OItem_Class_Logstate.GUID)
    End Sub
End Class
