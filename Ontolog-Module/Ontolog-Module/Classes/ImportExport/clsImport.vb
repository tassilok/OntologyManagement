...
Public Class clsImport
    ...
    Private objOList_OItems As New List(Of clsOntologyItem)
    Private objOList_Classes As New List(Of clsOntologyItem)
    Private objOList_ClassAtts As New List(Of clsClassAtt)
    Private objOList_ClassRel As New List(Of clsClassRel)
    Private objOList_ObjAtt As New List(Of clsObjectAtt)
    ...
    Public Function ImportXMLFiles(strPath As String) As clsOntologyItem
        Dim objOItem_Result = objGlobals.LState_Success.Clone()
    ...
    Private Function SaveItems() As clsOntologyItem
        Dim objOItem_Result = objGlobals.LState_Success.Clone()
    ...
    Private Function AddItemsFromXMLStream(objXMLStream As Stream) As clsOntologyItem
    ...
    Private Function File(objOList_Classes As List(Of clsOntologyItem), Optional objOItem_Class As clsOntologyItem = Nothing) As clsOntologyItem
