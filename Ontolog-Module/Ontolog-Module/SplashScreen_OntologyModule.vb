Public NotInheritable Class SplashScreen_OntologyModule
    ...
    Private Sub SplashScreen_OntologyModule_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
