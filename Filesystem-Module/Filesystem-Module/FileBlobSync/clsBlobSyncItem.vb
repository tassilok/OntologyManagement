Public Class clsBlobSyncItem
    Public Property ID_FileSync As String
    Public Property Name_FileSync As String
    Public Property ID_Direction As String
    Public Property Name_Direction As String
    Public Property ID_File_Src As String
    Public Property Name_File_Src As String
