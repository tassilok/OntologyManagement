...
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\Ontology-Module_0.3.0.132.exe" -o"%OMODULE_PATH%\Ontology-Module\"

del /s /q "%OMODULE_PATH%\File-Tagging-Module\*.*"
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\File-Tagging-Module_0.0.0.46.exe" -o"%OMODULE_PATH%\File-Tagging-Module\"

del /s /q "%OMODULE_PATH%\Security-Module\*.*"
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\Security-Module_0.2.0.44.exe" -o"%OMODULE_PATH%\Security-Module\"

del /s /q "%OMODULE_PATH%\PortListenerForText-Module\*.*"
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\PortListenerForText-Module_0.0.0.16.exe" -o"%OMODULE_PATH%\PortListenerForText-Module\"

del /s /q "%OMODULE_PATH%\ElasticSearchConfig-Module\*.*"
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\ElasticSearchConfig-Module_0.0.0.44.exe" -o"%OMODULE_PATH%\ElasticSearchConfig-Module\"

del /s /q "%OMODULE_PATH%\ModuleLibrary\*.*"
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\ModuleLibrary_0.0.0.51.exe" -o"%OMODULE_PATH%\ModuleLibrary\"

del /s /q "%OMODULE_PATH%\Variable-Value-Module\*.*"
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\Variable-Value-Module_0.0.0.40.exe" -o"%OMODULE_PATH%\Variable-Value-Module\"

del /s /q "%OMODULE_PATH%\RDF-Module\*.*"
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\RDF-Module_0.0.0.79.exe" -o"%OMODULE_PATH%\RDF-Module\"

del /s /q "%OMODULE_PATH%\Localization-Module\*.*"
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\Localization-Module_0.0.1.45.exe" -o"%OMODULE_PATH%\Localization-Module\"

del /s /q "%OMODULE_PATH%\Formale-Begriffsanalyse-Module\*.*"
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\Formale-Begriffsanalyse-Module_0.0.0.45.exe" -o"%OMODULE_PATH%\Formale-Begriffsanalyse-Module\"

del /s /q "%OMODULE_PATH%\Grid-Module\*.*"
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\Grid-Module_0.0.0.3.exe" -o"%OMODULE_PATH%\Grid-Module\"

del /s /q "%OMODULE_PATH%\NextGenerationOntoEdit\*.*"
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\NextGenerationOntoEdit_0.0.0.4.exe" -o"%OMODULE_PATH%\NextGenerationOntoEdit\"

del /s /q "%OMODULE_PATH%\GraphMLConnector\*.*"
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\GraphMLConnector_0.0.0.90.exe" -o"%OMODULE_PATH%\GraphMLConnector\"

del /s /q "%OMODULE_PATH%\Hierarchichal-Splitter-Module\*.*"
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\Hierarchichal-Splitter-Module_0.0.0.49.exe" -o"%OMODULE_PATH%\Hierarchichal-Splitter-Module\"

del /s /q "%OMODULE_PATH%\Ping-Test-Module\*.*"
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\Ping-Test-Module_0.0.0.41.exe" -o"%OMODULE_PATH%\Ping-Test-Module\"

del /s /q "%OMODULE_PATH%\Log-Manager\*.*"
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\Log-Manager_0.2.0.52.exe" -o"%OMODULE_PATH%\Log-Manager\"

del /s /q "%OMODULE_PATH%\TimeManagement-Module\*.*"
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\TimeManagement-Module_0.0.0.89.exe" -o"%OMODULE_PATH%\TimeManagement-Module\"

del /s /q "%OMODULE_PATH%\ElasticSearchLogging-Module\*.*"
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\ElasticSearchLogging-Module_0.0.0.46.exe" -o"%OMODULE_PATH%\ElasticSearchLogging-Module\"
...
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\BankTransaction-Module_0.0.1.65.exe" -o"%OMODULE_PATH%\BankTransaction-Module\"
...
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\Process-Module_0.2.0.83.exe" -o"%OMODULE_PATH%\Process-Module\"
...
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\Bill-Module_0.0.0.98.exe" -o"%OMODULE_PATH%\Bill-Module\"

del /s /q "%OMODULE_PATH%\Literaturquellen-Module\*.*"
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\Literaturquellen-Module_0.0.0.140.exe" -o"%OMODULE_PATH%\Literaturquellen-Module\"

del /s /q "%OMODULE_PATH%\Change-Module\*.*"
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\Change-Module_0.0.0.101.exe" -o"%OMODULE_PATH%\Change-Module\"

del /s /q "%OMODULE_PATH%\Checklist-Module\*.*"
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\Checklist-Module_0.0.0.128.exe" -o"%OMODULE_PATH%\Checklist-Module\"
