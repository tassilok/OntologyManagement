...
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\Filesystem-Module_0.2.0.84.exe" -o"%OMODULE_PATH%\Filesystem-Module\"
...
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\HTMLExport-Module_0.0.0.83.exe" -o"%OMODULE_PATH%\HTMLExport-Module\"

del /s /q "%OMODULE_PATH%\TextParser\*.*"
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\TextParser_0.0.0.96.exe" -o"%OMODULE_PATH%\TextParser\"

del /s /q "%OMODULE_PATH%\Office-Module\*.*"
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\Office-Module_0.0.1.63.exe" -o"%OMODULE_PATH%\Office-Module\"

del /s /q "%OMODULE_PATH%\Typed-Tagging-Module\*.*"
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\Typed-Tagging-Module_0.0.0.77.exe" -o"%OMODULE_PATH%\Typed-Tagging-Module\"
...
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\CommandLineRun-Module_0.0.0.38.exe" -o"%OMODULE_PATH%\CommandLineRun-Module\"
...
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\DatabaseConfigurationModule_0.0.0.16.exe" -o"%OMODULE_PATH%\DatabaseConfigurationModule\"

del /s /q "%OMODULE_PATH%\ScriptingModule\*.*"
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\ScriptingModule_0.0.0.7.exe" -o"%OMODULE_PATH%\ScriptingModule\"

del /s /q "%OMODULE_PATH%\CommandLineCL-Module\*.*"
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\CommandLineCL-Module_0.0.0.31.exe" -o"%OMODULE_PATH%\CommandLineCL-Module\"
...
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\FileResourceModule_0.0.0.75.exe" -o"%OMODULE_PATH%\FileResourceModule\"

del /s /q "%OMODULE_PATH%\FileSystem-Connector-Module\*.*"
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\FileSystem-Connector-Module_0.0.0.82.exe" -o"%OMODULE_PATH%\FileSystem-Connector-Module\"

del /s /q "%OMODULE_PATH%\Scenes-Literatur-Module\*.*"
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\Scenes-Literatur-Module_0.0.1.80.exe" -o"%OMODULE_PATH%\Scenes-Literatur-Module\"

del /s /q "%OMODULE_PATH%\Process-Module\*.*"
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\Process-Module_0.2.0.80.exe" -o"%OMODULE_PATH%\Process-Module\"

del /s /q "%OMODULE_PATH%\OutlookConnector-Module\*.*"
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\OutlookConnector-Module_0.0.0.93.exe" -o"%OMODULE_PATH%\OutlookConnector-Module\"
...
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\Report-Module_0.0.1.119.exe" -o"%OMODULE_PATH%\Report-Module\"
...
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\Schriftverkehrs-Module_0.0.0.113.exe" -o"%OMODULE_PATH%\Schriftverkehrs-Module\"
...
"%PROGRAMFILES%\7-Zip\7z.exe" x "%OMODULE_INST_PATH%\Checklist-Module_0.0.0.126.exe" -o"%OMODULE_PATH%\Checklist-Module\"
