...
wget -O "%temp%\OModules\FileResourceModule_0.1.0.115.exe" %DOWNLOAD_URL%/FileResourceModule_0.1.0.115.exe/download
"%PROGRAMFILES%\7-Zip\7z.exe" x "%temp%\OModules\FileResourceModule_0.1.0.115.exe" -o"%OMODULE_PATH%\FileResourceModule\"
...
wget -O "%temp%\OModules\TextParser_0.1.0.136.exe" %DOWNLOAD_URL%/TextParser_0.1.0.136.exe/download
"%PROGRAMFILES%\7-Zip\7z.exe" x "%temp%\OModules\TextParser_0.1.0.136.exe" -o"%OMODULE_PATH%\TextParser\"
...
wget -O "%temp%\OModules\Development-Module_0.3.0.163.exe" %DOWNLOAD_URL%/Development-Module_0.3.0.163.exe/download
"%PROGRAMFILES%\7-Zip\7z.exe" x "%temp%\OModules\Development-Module_0.3.0.163.exe" -o"%OMODULE_PATH%\Development-Module\"
