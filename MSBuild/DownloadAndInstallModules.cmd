...
wget -O "%temp%\OModules\OutlookConnector-Module_0.1.0.123.exe" %DOWNLOAD_URL%/OutlookConnector-Module_0.1.0.123.exe/download
"%PROGRAMFILES%\7-Zip\7z.exe" x "%temp%\OModules\OutlookConnector-Module_0.1.0.123.exe" -o"%OMODULE_PATH%\OutlookConnector-Module\"
...
wget -O "%temp%\OModules\Literaturquellen-Module_0.1.0.169.exe" %DOWNLOAD_URL%/Literaturquellen-Module_0.1.0.169.exe/download
"%PROGRAMFILES%\7-Zip\7z.exe" x "%temp%\OModules\Literaturquellen-Module_0.1.0.169.exe" -o"%OMODULE_PATH%\Literaturquellen-Module\"
