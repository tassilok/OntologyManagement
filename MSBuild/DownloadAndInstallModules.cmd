...
wget -O "%temp%\OModules\TextParser_0.1.0.125.exe" %DOWNLOAD_URL%/TextParser_0.1.0.125.exe/download
"%PROGRAMFILES%\7-Zip\7z.exe" x "%temp%\OModules\TextParser_0.1.0.125.exe" -o"%OMODULE_PATH%\TextParser\"
...
wget -O "%temp%\OModules\Development-Module_0.3.0.148.exe" %DOWNLOAD_URL%/Development-Module_0.3.0.148.exe/download
"%PROGRAMFILES%\7-Zip\7z.exe" x "%temp%\OModules\Development-Module_0.3.0.148.exe" -o"%OMODULE_PATH%\Development-Module\"
...
wget -O "%temp%\OModules\FileResourceModule_0.1.0.104.exe" %DOWNLOAD_URL%/FileResourceModule_0.1.0.104.exe/download
"%PROGRAMFILES%\7-Zip\7z.exe" x "%temp%\OModules\FileResourceModule_0.1.0.104.exe" -o"%OMODULE_PATH%\FileResourceModule\"
