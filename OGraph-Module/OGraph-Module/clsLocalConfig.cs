...
namespace OGraph_Module
{
    ...
    {
        private const string cstrID_Ontology = "192ce52fcd1a4af8bb0cbf9a539c4f65";
	...
	private void get_Config()
        {
            ...
            catch(Exception ex)
            {
                ...
                if (WPFMessageBox.Show(strTitle + ": Die notwendigen Basisdaten konnten nicht geladen werden! Soll versucht werden, sie in der Datenbank " +
