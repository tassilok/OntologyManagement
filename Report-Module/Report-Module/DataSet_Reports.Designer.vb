...
Partial Public Class DataSet_Reports
    ...
    Partial Public Class dtbl_ColumnsDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function Adddtbl_ColumnsRow(ByVal name As String, ByVal name_type As String, ByVal max_length As Short) As dtbl_ColumnsRow
            Dim rowdtbl_ColumnsRow As dtbl_ColumnsRow = CType(Me.NewRow,dtbl_ColumnsRow)
            Dim columnValuesArray() As Object = New Object() {name, name_type, max_length}
    ...
    Partial Public Class dtbl_ColumnsRow
        ...
        Public Property max_length() As Short
            Get
                Return CType(Me(Me.tabledtbl_Columns.max_lengthColumn),Short)
            End Get
            Set
                Me(Me.tabledtbl_Columns.max_lengthColumn) = value
            End Set
        End Property
...
Namespace DataSet_ReportsTableAdapters
    ...
    Partial Public Class dtbl_ColumnsTableAdapter
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Report_Module.My.MySettings.Default.ont_db_reportsConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT sys.columns.name,sys.types.name AS name_type, sys.columns.max_length"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM"& _ 
                " sys.columns"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"INNER JOIN sys.types ON sys.types.system_type_id = sys.columns.sys"& _ 
                "tem_type_id"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"INNER JOIN sys.objects ON sys.objects.object_id = sys.columns.objec"& _ 
                "t_id"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE sys.objects.name=@Name_View AND NOT sys.types.name='sysname'"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"ORDER "& _ 
                "BY name"
